    ...
    <div>
         ...
         <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
                ...
                <RadioGroup row id="avatar" label="Player Avatar" onChange={(event) => {setAvatar(event.target.value)}} value={avatar} defaultValue={player.avatar}>    
                    <FormControlLabel label={
                        <img src="../../static/0.png" alt="Avatar 0" width="50" height="50" />
                    }   
                    value="0" control={<Radio />} />
                    <FormControlLabel label={
                        <img src="../../static/1.png" alt="Avatar 1" width="50" height="50" />
                    }    
                    value="1" control={<Radio />} />
                    <FormControlLabel label={
                        <img src="../../static/2.png" alt="Avatar 2" width="50" height="50" />
                    }    
