    ...
    <Layout classroom role={player.role}>
      ...
      >
        ...
        <Box sx={{ display: "flex", marginTop: "20px" }}>
          ...
          >
            <Typography sx={{ fontSize: "25px", marginTop: "38px" }}>
              Powerups
            </Typography>
            <Typography sx={{ fontSize: "25px", marginTop: "38px" }}>
              Streak
      ...
      <Routes>
        ...
        <Route
          path="main"
          element={<Main classroom={classroom} player={player} />}
        />
        <Route
          path="shop"
          element={<Shop classroom={classroom} player={player} />}
        />
        <Route
          path="class-student"
          element={
            <ClassStudent player={player} classroom={classroom} user={user} />
          }
        />
        <Route
          path="inventory"
          element={<Inventory player={player} classroom={classroom} />}
        />
        <Route
          path="*"
          element={
