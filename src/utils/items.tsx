...
export class Hair implements Item {
  ...
  constructor(id: number, subtype: string) {
    this.id = id;
    this.name =
      capitalize(hairColors[id]) + " " + subtype.replaceAll("_", " ") + " hair";
    this.description =
      capitalize(hairColors[id]) +
      " " +
      subtype.replaceAll("_", " ") +
      " hair for your avatar!";
    this.#spriteStart = 8 * id + 1;
...
export class Pants implements Item {
  ...
  constructor(id: number) {
    ...
    this.description =
      capitalize(clothingColors[id]) + " pants for your avatar!";
    this.#spriteStart = 8 * id + 1;
  }
...
export class Shoes implements Item {
  ...
  constructor(id: number) {
    ...
    this.description =
      capitalize(clothingColors[id]) + " shoes for your avatar!";
    this.#spriteStart = 8 * id + 1;
  }
...
export function currentAvatar(player: Player) {
  const playerOutfit = {
    ...
    hair:
      player.ava_hair && player.ava_hair_subtype
        ? new Hair(player.ava_hair, player.ava_hair_subtype)
        : new Hair(0, "bob"),
